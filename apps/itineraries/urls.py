...
urlpatterns = [
    ...
    path('<int:itinerary_id>/add-stops/', views.add_stops_view, name='add_stops'),
    path('<int:itinerary_id>/preview/', views.itinerary_preview_view, name='preview_itinerary'),
    path('<int:itinerary_id>/edit/', views.edit_itinerary_view, name='edit_itinerary'),
